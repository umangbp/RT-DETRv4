...
def stats(
    ...
    # FLOPs profiling does not need the GPU. Keep both the copied
    # model and calflops' synthetic input on CPU to avoid device
    # mismatches during this diagnostic forward pass.
